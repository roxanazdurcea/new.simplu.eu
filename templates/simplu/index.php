...
$doc->addScriptVersion($this->baseurl . '/templates/' . $this->template . '/js/simplu.js');

// Add Stylesheets
$doc->addStyleSheetVersion($this->baseurl . '/templates/' . $this->template . '/css/template.css');
$doc->addStyleSheetVersion($this->baseurl . '/templates/' . $this->template . '/css/simplu.css');
...
?>">
	...
	<div class="body">
        ...
        <div style="background-color: #efefef;">
            <div class="container">
                <div class="col-sm-9">
                    <jdoc:include type="modules" name="position-rox" style="none"/>
                </div>
                <div class="col-sm-3">
	...
	<footer class="footer" role="contentinfo">
      ...
      <div style="background-color: #050505; padding: 1% 0 1% 0;">
        	<p class="pull-right">
				<a href="#" id="back-top">
              ...
              © Copyright 2016 <a href="http://bmbc.co/index.php/en/">bmbc.co</a> All rights reserved</span>
        	</h4>
