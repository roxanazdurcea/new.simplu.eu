			...
			<div class="toolbar" id="toolbar" style="float: right;">
				<table>
					<tr>
						...
						<td><a onclick="javascript:submitbutton('export<?php echo ucfirst(JRequest::getCmd('task')); ?>')" href="#" ><span class="icon-32-acyexport" title="<?php echo JText::_('ACY_EXPORT',true); ?>"></span><?php echo JText::_('ACY_EXPORT'); ?></a></td><td>
						</td>
						<?php } ?>
						<?php if(JRequest::getInt('fromdetail') == 1){ ?>
							<td><a href="<?php $link = $this->app->isAdmin() ? 'diagram&task=mailing' : 'frontnewsletter&task=stats&listid='.JRequest::getInt('listid'); echo acymailing_completeLink($link.'&mailid='.JRequest::getInt('filter_mail'),true); ?>" ><span class="icon-32-cancel" title="<?php echo JText::_('ACY_CANCEL',true); ?>"></span><?php echo JText::_('ACY_CANCEL'); ?></a></td>
						<?php } ?>
					</tr>
				</table>
			</div>
